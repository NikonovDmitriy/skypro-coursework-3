package com.example.skyprocoursework3.services.task.java;

import com.example.skyprocoursework3.models.Task;
import com.example.skyprocoursework3.repositories.JavaTasksRepository;
...
class JavaTaskServiceTest {

    @Mock
    private JavaTasksRepository repository;

    @InjectMocks
    private JavaTaskService service;
